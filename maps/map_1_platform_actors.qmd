...
format:
  html:
    embed-resources: true      # <--- This is the key fix
    toc: true
    toc-depth: 3
    toc-location: left
...
<details>
<summary>**Click to expand diagnostics** (Quality assurance tables for identifying potential misclassifications)</summary>
